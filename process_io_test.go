...
func TestSimpleProcess(t *testing.T) {
	...
	if assert.NoError(t, err) {
		assert.Equal(t, point.user, uint64(0))
		assert.Equal(t, point.system, uint64(1))
	}
	point, err = parseProcStat(strings.NewReader(`1735 (sh) S 1734 1735 1735 34816 2679 4218880 655 3141 0 0 0 0 152 189 20 0 1 0 182865 12144640 534 18446744073709551615 4194304 4729572 140730058798800 140730058796792 139881841869352 0 0 2637828 2 0 0 0 17 0 0 0 0 0 0 6826728 6830659 16642048 140730058800890 140730058800894 140730058800894 140730058801136 0`))
	if assert.NoError(t, err) {
		assert.Equal(t, point.user, uint64(152))
		assert.Equal(t, point.system, uint64(189))
	}
}
...
func TestBrokenProcess(t *testing.T) {
	...
	assert.Error(t, err)
	_, err = parseProcStat(strings.NewReader(`1735 (sh) S 1734 1735 1735 34816 2679 4218880 655 3141 0 0 0 0 frob 1 20 0 1 0 182865 12144640 534 18446744073709551615 4194304 4729572 140730058798800 140730058796792 139881841869352 0 0 2637828 2 0 0 0 17 0 0 0 0 0 0 6826728 6830659 16642048 140730058800890 140730058800894 140730058800894 140730058801136 0`))
	assert.Error(t, err)
	_, err = parseProcStat(strings.NewReader(`1735 (sh) S 1734 1735 1735 34816 2679 4218880 655 3141 0 0 0 0 0 botz 20 0 1 0 182865 12144640 534 18446744073709551615 4194304 4729572 140730058798800 140730058796792 139881841869352 0 0 2637828 2 0 0 0 17 0 0 0 0 0 0 6826728 6830659 16642048 140730058800890 140730058800894 140730058800894 140730058801136 0`))
	assert.Error(t, err)
	_, err = parseProcStat(strings.NewReader(`1735 (sh) S 1734 1735 1735 34816 2679 4218880 655 3141 0 0 0 0 -1 1 20 0 1 0 182865 12144640 534 18446744073709551615 4194304 4729572 140730058798800 140730058796792 139881841869352 0 0 2637828 2 0 0 0 17 0 0 0 0 0 0 6826728 6830659 16642048 140730058800890 140730058800894 140730058800894 140730058801136 0`))
	assert.Error(t, err)
}
